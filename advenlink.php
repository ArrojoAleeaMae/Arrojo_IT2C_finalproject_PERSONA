        ...
        <div class="bg-white shadow rounded overflow-hidden">
            ...
            <div class="px-4 py-3">
                <div class="p-4 rounded shadow-sm bg-light">
                    <h1 class="text-info text-center">Adventure</h1>
                    <?php
                    ...
                    <li class="list-inline-item text-center">
                        <?php 
                            ...
                            echo '<a href="https://www.adventuredeficit.com/short-stories">Nature</a>';
                            echo "<br/>";

                            echo '<a href="https://www.shortstories.net/for-children/adventures-stories/">Kids Adventure</a>';
                            echo "<br/>";

                            echo '<a href="https://jessieonajourney.com/short-adventure-stories/">Travel Adventure</a>';
                            echo "<br/>";
                        ?>
                        <br/>
