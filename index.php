...
$password = "mae";
$title = " PERSONA";
$caption = "Collect stories now! The more you read, the more things you will know!";

//check the currenrt url for the redirections later
$url_add = "http://".$_SERVER['HTTP_HOST'].$_SERVER['PHP_SELF'];


//condition to know if the button is clicked
if (isset($_REQUEST['login_button']) === true){
	//get the username and password from the form and compare to the predefined username ans password
	//kapag mali agad yung username

		if ($_REQUEST['form_username'] != $username) {
			header("Location: ".$url_add."?notexist");

		}
		//tama ang username pero mali ang password
		else if ($_REQUEST['form_username'] == $username && $_REQUEST['form_password'] != $password) {
...
<html lang="en">
  <head>
	...
	<body>
		<header class=" bg-gradient text-black">
		...
		<div class="container">
			<div class="row justify-content-center">
				<div class="col-md-6 col-lg-5">
		      	...
		      	<h3 class="text-center mb-4">Login To Open Persona</h3>
	            ...
	            <div class="form-group">
	            	<button type="submit" class="btn btn-primary rounded submit p-3 px-5" name="login_button">Open</button>
	            </div>
	          </form>
