        ...
        <div class="bg-white shadow rounded overflow-hidden">
            ...
            <div class="px-4 py-3">
                    <div class="p-4 rounded shadow-sm bg-light">
                        <h1 class="text-info text-center">About</h1>
                        <?php
                            echo "<p class='text-center blockquote-footer'>PERSONA is a website services helping its user to read, write, collect and edit literary content.<p/>";
                        ?>
                    </div>

                    <div class="p-4 rounded shadow-sm bg-light">
                        <h1 class="text-info text-center">What's New</h1>
                        <?php
                            echo "<p class='text-center blockquote-footer'>This is a multi-page index, collecting, listing and editing stories are on this site, you can save it and read it later on. This site also provide access to those stories online.<p/>";
                        ?>
                    </div>
                    ...
                    <div class="col-lg-5  col-md-6 col-sm-6 ">
                            <div class="single-footer-widget">
                                <p>Stay update with our latest stories</p>
