        ...
        <div class="bg-white shadow rounded overflow-hidden">
            ...
            <div class="px-4 py-3">
                <div class="p-4 rounded shadow-sm bg-light">
                    <h1 class="text-info text-center">Science-Fiction Stories</h1>
                    <?php
                    ...
                    <li class="list-inline-item text-center">
                        <?php 
                            ...
                            echo '<a href="https://www.gutenberg.org/ebooks/35">The Time Machine</a>';
                            echo "<br/>";

                            echo '<a href="https://www.shortstories101.com/story/times-gone-by/">Times Gone By</a>';
                            echo "<br/>";

                            echo '<a href="https://www.shortstories101.com/story/matter-of-time/">A Matter of Time</a>';
                            echo "<br/>";

                            echo '<a href="https://www.shortstories101.com/story/under-the-darkness/">Under the Darkness</a>';
                            echo "<br/>";
                        ?>
                        <br/>
