        ...
        <div class="bg-white shadow rounded overflow-hidden">
            ...
            <div class="px-4 py-3">
                <div class="p-4 rounded shadow-sm bg-light">
                    <h1 class="text-info text-center">Poetry</h1>
                    <?php
                    ...
                    <li class="list-inline-item text-center">
                        <?php 
                            ...
                            echo '<a href="https://www.goodreads.com/book/show/23513349-milk-and-honey">Milk and Honey</a>';
                            echo "<br/>";

                            echo '<a href="https://www.goodreads.com/book/show/23841432-night-sky-with-exit-wounds">Night Sky with Exit Wounds</a>';
                            echo "<br/>";

                            echo '<a href="https://www.goodreads.com/book/show/395090.Ariel">Ariel</a>';
                            echo "<br/>";

                            echo '<a href="https://www.goodreads.com/book/show/35430013-a-thousand-beginnings-and-endings">A Thousand Beginnings and Endings</a>';
                            echo "<br/>";
                        ?>
                        <br/>
